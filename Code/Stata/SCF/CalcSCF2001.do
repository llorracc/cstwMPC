* This file i) calculates the fraction of households whose wealth level is between 0.5*mean and 1.5*mean, and ii) the distribution of wealth/permanent income ratio, using SCF2001
...
drop if PINCOME <=0  
replace PINCOME = PINCOME *0.81 /* Adjust with CPI (adjusted to 1992$ price) */   
sum PINCOME [weight= WGT]
gen NPINCOME = PINCOME /57579.46   /* P/M[P] */
...
* SCF2001
replace LiqFINPlsRet    = LiqFINPlsRet*0.79
