...
* SCF1998
replace LiqFINPlsRet    = LiqFINPlsRet*0.86
...
* SCF1998
gen MLiqFINPlsRetYRATIO = (LiqFINPlsRet+CINCOME*0.87/4)/(PINCOME/4) /* note that current inc in the prev yr was reported */
...
gen CumLiqFINPlsRet Dist = 100-cumLiqFINPlsRet 
line CumLiqFINPlsRet Dist percentileLiqFINPlsRet 
*/
...
mean AggLiqFINPlsRetYRATIO /* show aggregate LiqFINPlsRet YRATIO */
