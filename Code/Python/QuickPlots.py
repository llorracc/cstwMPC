...
def doCforBetaEquals(beta,m):
    ...
    m_hist = Model.simulateMoneyHistory(Params.sim_periods*InfiniteType.cFunc, w0_vector*0.0, InfiniteType.perm_shocks, InfiniteType.temp_shocks)
...
for b in range(17):
    ...
    plt.savefig('./Figures/mDistBeta' + mystr(beta) + '.pdf')
    plt.show()
