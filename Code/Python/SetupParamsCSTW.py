...
do_sensitivity = [False, False, False, False, False, False, False] # rho, xi_sigma, psi_sigma, mu, urate, mortality, g
...
working_T = 41*4
retired_T = 55*4
total_T = working_T+retired_T
rho = 1
beta_guess = 0.99
p_unemploy = 0.07
p_unemploy_retire = 0.0005
income_unemploy = 0.15
...
# Define the paths of permanent and transitory shocks
...
Gamma_h.reverse()
Gamma_c.reverse()
survival_probs_d.reverse()
survival_probs_h.reverse()
survival_probs_c.reverse()
...
init_dropout = {"rho":rho,
                ...
                "T_retire":retired_T+1, # check this
