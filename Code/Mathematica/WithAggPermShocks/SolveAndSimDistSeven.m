...
Export["kLevListDistSeven.txt", kLevListDistSevenWithAggPermShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenWithAggPermShock.txt", kLevListDistSevenWithAggPermShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenBottomHalfWithAggPermShock.tex", Round[100 MeanMPCBottomHalfBykAnnual]/100//N, "Table"];

Export[ParentDirectory[] <> "/Results/AggStatsDistSevenWithAggPermShocks.txt", AggStatsWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCListDistSevenWithAggPermShocks.txt",             MPCListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCLargeBadPermListDistSevenWithAggPermShocks.txt", MPCLargeBadPermListWithAggShock, "Table"]; (* MPC list when a large bad perm shock is given *)
Export[ParentDirectory[] <> "/Results/MPCLargeBadTranListDistSevenWithAggPermShocks.txt", MPCLargeBadTranListWithAggShock, "Table"]; (* MPC list when a large bad tran shock is given *)
Export["MPCsList.txt", MPCt, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenWithAggPermShocks.tex", Round[100 MeanMPCAnnual]/100//N, "Table"];

Export[ParentDirectory[] <> "/Results/MPCAltListDistSevenWithAggPermShocks.txt",             MPCAltListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCAltDistSevenWithAggPermShocks.tex", Round[100 MeanMPCAltAnnual]/100//N, "Table"];
