...
\[Beta]middle = Import["BetamiddleLiqFin.txt","List"][[1]]; (* Mean of time pref factors *)
diff = Import["diffLiqFin.txt","List"][[1]]; (* Diff between approximated points (of time pref factors) *)
...
Export["kLevListDistSevenLiqFin.txt", kLevListDistSevenWithAggPermShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenWithAggPermShockLiqFin.txt", kLevListDistSevenWithAggPermShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenBottomHalfWithAggPermShockLiqFin.tex", Round[100 MeanMPCBottomHalfBykAnnual]/100//N, "Table"];

Export[ParentDirectory[] <> "/Results/AggStatsDistSevenWithAggPermShocksLiqFin.txt", AggStatsWithAggShock, "Table"];
Export["MPCsLiqFinList.txt", MPCt, "Table"];
Export[ParentDirectory[] <> "/Results/MPCListDistSevenWithAggPermShocksLiqFin.txt", MPCListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenWithAggPermShocksLiqFin.tex", Round[100 MeanMPCAnnual]/100//N, "Table"];
