(* SolveAndSimDistSevenLiqFinPlsRetDeathFrAge.m *)
...
\[Beta]middle = Import["BetamiddleLiqFinPlsRetDeathFrAge.txt","List"][[1]]; (* Mean of time pref factors *)
diff = Import["diffLiqFinPlsRetDeathFrAge.txt","List"][[1]]; (* Diff between approximated points (of time pref factors) *)
...
Export["kLevListDistSevenLiqFinPlsRetDeathFrAge.txt", kLevListDistSevenWithAggPermShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenWithAggPermShockLiqFinPlsRetDeathFrAge.txt", kLevListDistSevenWithAggPermShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenBottomHalfWithAggPermShockLiqFinPlsRetDeathFrAge.tex", Round[100 MeanMPCBottomHalfBykAnnual]/100//N, "Table"];

Export[ParentDirectory[] <> "/Results/AggStatsDistSevenWithAggPermShocksLiqFinPlsRetDeathFrAge.txt", AggStatsWithAggShock, "Table"];
Export["MPCsLiqFinPlsRetList.txt", MPCt, "Table"];
Export[ParentDirectory[] <> "/Results/MPCListDistSevenWithAggPermShocksLiqFinPlsRetDeathFrAge.txt", MPCListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenWithAggPermShocksLiqFinPlsRetDeathFrAge.tex", Round[100 MeanMPCAnnual]/100//N, "Table"];

Export[ParentDirectory[] <> "/Results/MPCAltListDistSevenWithAggPermShocksLiqFinPlsRetDeathFrAge.txt", MPCAltListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCAltDistSevenWithAggPermShocksLiqFinPlsRetDeathFrAge.tex", Round[100 MeanMPCAltAnnual]/100//N, "Table"]; 
