...
\[Beta]middle = Import["BetamiddleAltParamsLiqFinPlsRet.txt","List"][[1]]; (* Mean of time pref factors *)
diff = Import["diffAltParamsLiqFinPlsRet.txt","List"][[1]]; (* Diff between approximated points (of time pref factors) *)
...
Export["kLevListDistSevenAltParamsLiqFinPlsRet.txt", kLevListDistSevenAltParamsWithAggPermShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenAltParamsWithAggPermShockLiqFinPlsRet.txt", kLevListDistSevenAltParamsWithAggPermShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenAltParamsBottomHalfWithAggPermShockLiqFinPlsRet.tex", Round[100 MeanMPCBottomHalfBykAnnual]/100//N, "Table"];

Export[ParentDirectory[] <> "/Results/AggStatsDistSevenAltParamsWithAggPermShocksLiqFinPlsRet.txt", AggStatsWithAggShock, "Table"];
Export["MPCsLiqFinPlsRetList.txt", MPCt, "Table"];
Export[ParentDirectory[] <> "/Results/MPCListDistSevenAltParamsWithAggPermShocksLiqFinPlsRet.txt", MPCListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenAltParamsWithAggPermShocksLiqFinPlsRet.tex", Round[100 MeanMPCAnnual]/100//N, "Table"];
