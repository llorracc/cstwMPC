...
kLevListPointWithAggShock = Import["kLevListPointWithAggShock.txt","List"]; (* Raw time preference factor *) 
...
\\begin{tabular}{ld{4}d{4}d{5}d{3}}
\\toprule
&  \\multicolumn{3}{c}{Income Process} &  \\\\ \\cmidrule(r){2-4}
&  \\multicolumn{1}{c}{KS-JEDC} &  \\multicolumn{2}{c}{Friedman/ Buffer Stock$^{\\ddagger}$}   & \\\\
  \\cmidrule(l){2-2} \\cmidrule(l){3-4}
&   \\multicolumn{1}{c}{Our Solution} & \\multicolumn{1}{c}{No Aggr Unc}  & \\multicolumn{1}{c}{KS Aggr Unc}    & \\multicolumn{1}{c}{U.S.\\ Data$^{*}$}\\\\ \\midrule"; 
...
Export["WDistcstKS.tex", WDistcstKS, "text"]; 
