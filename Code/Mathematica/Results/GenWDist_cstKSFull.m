...
kLevListPointNoAggShockHighTran = Import["kLevListPointNoAggShockHighTran.txt","List"];  
kLevListPointNoAggShockHighTran = Reverse[kLevListPointNoAggShockHighTran];
kLevListPointNoAggShockHighTran = Round[10 kLevListPointNoAggShockHighTran]/10;

kLevListPointNoAggShockHighPerm = Import["kLevListPointNoAggShockHighPerm.txt","List"];  
kLevListPointNoAggShockHighPerm = Reverse[kLevListPointNoAggShockHighPerm];
kLevListPointNoAggShockHighPerm = Round[10 kLevListPointNoAggShockHighPerm]/10;
...
\\begin{tabular}{ld{4}d{4}d{4}d{4}d{4}d{4}d{4}d{3}}
\\toprule
 &  \\multicolumn{7}{c}{Income Process} &  \\\\ \\cmidrule(r){2-8}
&  \\multicolumn{1}{c}{KS-JEDC} &  \\multicolumn{6}{c}{Friedman/ Buffer Stock$^{\\ddagger}$}   & \\\\
  \\cmidrule(r){2-2} \\cmidrule(l){3-8}
&   \\multicolumn{1}{c}{Our Solution} & \\multicolumn{3}{c}{No Aggr Unc}  & \\multicolumn{3}{c}{KS Aggr Unc}    & \\\\
\\cmidrule(r){3-5} \\cmidrule(l){6-8}
Percentile of &  & \\multicolumn{1}{c}{$\\sigma^2_\\psi=0.01$}  & \\multicolumn{1}{c}{$\\sigma^2_\\psi=0.01$} & \\multicolumn{1}{c}{$\\sigma^2_\\psi=0.03$} & \\multicolumn{1}{c}{$\\sigma^2_\\psi=0.01$}  & \\multicolumn{1}{c}{$\\sigma^2_\\psi=0.01$} & \\multicolumn{1}{c}{$\\sigma^2_\\psi=0.03$} &
\\\\
Net Worth &  & \\multicolumn{1}{c}{$\\sigma^2_\\theta=0.01$} & \\multicolumn{1}{c}{$\\sigma^2_\\theta=0.15$} & \\multicolumn{1}{c}{$\\sigma^2_\\theta=0.01$} & \\multicolumn{1}{c}{$\\sigma^2_\\theta=0.01$} & \\multicolumn{1}{c}{$\\sigma^2_\\theta=0.15$} & \\multicolumn{1}{c}{$\\sigma^2_\\theta=0.01$} & \\multicolumn{1}{c}{Data$^{*}$}
\\\\
...
"&", 
kLevListPointNoAggShockHighTran[[2]]//N, 
"&", 
kLevListPointNoAggShockHighPerm[[2]]//N, 
"&", 
...
"&", 
kLevListPointNoAggShockHighTran[[4]]//N, 
"&", 
kLevListPointNoAggShockHighPerm[[4]]//N, 
"&", 
...
"&", 
kLevListPointNoAggShockHighTran[[5]]//N, 
"&", 
kLevListPointNoAggShockHighPerm[[5]]//N, 
"&", 
...
"&", 
kLevListPointNoAggShockHighTran[[7]]//N, 
"&", 
kLevListPointNoAggShockHighPerm[[7]]//N, 
"&", 
...
"&", 
kLevListPointNoAggShockHighTran[[9]]//N, 
"&",
kLevListPointNoAggShockHighPerm[[9]]//N, 
"&",
...
"&", 
kLevListPointNoAggShockHighTran[[10]]//N, 
"&", 
kLevListPointNoAggShockHighPerm[[10]]//N, 
"&", 
...
Export["WDist_cstKSFull.tex", WDistcstKSFull , "text"]; 
