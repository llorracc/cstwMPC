(* SolveAndSimDistSevenLiqFin.m *)
(* This file runs \[Beta]-Dist (uniformly distributed \[Beta]) model with time pref factors approximated by seven points. In the model, there are seven types of households. Using parameter values estimated by matching liquid FINANCIAL assets. *)
...
Print["Using parameter values estimated by matching liquid FINANCIAL assets"];

MatchLiqFinAssets  = Yes;    (* Matching liquid financial assets, not net worth *)
...
\[Beta]middle = Import["BetamiddleWithAggShocksLiqFin.txt","List"][[1]]; (* Mean of time pref factors *)
diff          = Import["diffWithAggShocksLiqFin.txt","List"][[1]];       (* Diff between approximated points (of time pref factors) *)
...
Export["kLevListDistSevenLiqFin.txt",                                           kLevListDistSevenWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenWithAggShockLiqFin.txt", kLevListDistSevenWithAggShock, "Table"];

Export[ParentDirectory[] <> "/Results/mRatMedianMeanDistSevenWithAggShockLiqFin.tex",        Round[10 mRatMedianMean]/10//N, "Table"];
Export[ParentDirectory[] <> "/Results/mRatMedianMeanAnnualDistSevenWithAggShockLiqFin.tex",  Round[10 mRatMedianMean/4]/10//N, "Table"];
Export[ParentDirectory[] <> "/Results/FracmRatBelow20MeanDistSevenWithAggShockLiqFin.tex",        Round[10 FracmRatBelow20Mean]/10//N, "Table"];
Export[ParentDirectory[] <> "/Results/FracmRatBelow05MeanAnnualDistSevenWithAggShockLiqFin.tex",  Round[10 FracmRatBelow20Mean]/10//N, "Table"]; (* fraction of mRat below 0.5 in annual terms *)


Export[ParentDirectory[] <> "/Results/AggStatsDistSevenWithAggShockLiqFin.txt", AggStatsWithAggShock, "Table"];
Export["MPCsListLiqFin.txt", MPCt, "Table"];
Export[ParentDirectory[] <> "/Results/MPCListDistSevenWithAggShockLiqFin.txt", MPCListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenWithAggShockLiqFin.tex", Round[100 MeanMPCAnnual]/100//N, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenBottomHalfLiqFin.tex", Round[100 MeanMPCBottomHalfBykAnnual]/100//N, "Table"];

(*
Export[ParentDirectory[] <> "/Results/kAR1Coeff1GoodDistSevenLiqFin.tex", Round[1000 kAR1ByAggState[[1,1]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff2GoodDistSevenLiqFin.tex", Round[1000 kAR1ByAggState[[1,2]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff1BadDistSevenLiqFin.tex",  Round[1000 kAR1ByAggState[[3,1]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff2BadDistSevenLiqFin.tex",  Round[1000 kAR1ByAggState[[3,2]]]/1000//N, "Table"];
*)
