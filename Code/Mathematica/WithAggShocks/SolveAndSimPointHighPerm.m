...
*)
\[Beta] = Import["BetaHighPerm.txt","List"][[1]]; (* Raw time preference factor *) 
...
Export["kLevListPointHighPerm.txt", kLevListPointWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListPointWithAggShockHighPerm.txt", kLevListPointWithAggShock, "Table"];

Export[ParentDirectory[] <> "/Results/AggStatsPointWithAggShockHighPerm.txt", AggStatsWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCListPointWithAggShockHighPerm.txt", MPCListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCPointWithAggShockHighPerm.tex", Round[100 MeanMPCAnnual]/100//N, "Table"];

Export[ParentDirectory[] <> "/Results/kAR1Coeff1GoodPointHighPerm.tex", Round[1000 kAR1ByAggState[[1,1]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff2GoodPointHighPerm.tex", Round[1000 kAR1ByAggState[[1,2]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff1BadPointHighPerm.tex",  Round[1000 kAR1ByAggState[[3,1]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff2BadPointHighPerm.tex",  Round[1000 kAR1ByAggState[[3,2]]]/1000//N, "Table"];
