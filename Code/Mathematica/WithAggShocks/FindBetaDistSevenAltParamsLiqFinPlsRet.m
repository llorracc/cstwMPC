...
\[Beta]middle = Import["BetamiddleAltParamsLiqFinPlsRet.txt", "List"][[1]];
...
Export["diffAltParamsWithAggShocksLiqFinPlsRet.txt", diffSolution, "Table"];
Export["BetamiddleAltParamsWithAggShocksLiqFinPlsRet.txt", \[Beta]middleSolution, "Table"];

Export[ParentDirectory[] <> "/Results/BetamiddleAltParamsWithAggShocksLiqFinPlsRet.tex",  Round[10000 \[Beta]middleSolution]/10000//N, "Table"];
Export[ParentDirectory[] <> "/Results/NablaAltParamsWithAggShocksLiqFinPlsRet.tex",       Round[10000 3.5 diffSolution]/10000//N, "Table"];
...
Export["BetamiddleAltParamsLiqFinPlsRet.txt", Import["BetamiddleOriginalLiqFinPlsRet.txt", "List"][[1]], "Table"];
