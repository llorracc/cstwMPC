...
\[Beta]middle = Import["BetamiddleWithAggShocksFin.txt","List"][[1]]; (* Mean of time pref factors *)
diff          = Import["diffWithAggShocksFin.txt","List"][[1]];       (* Diff between approximated points (of time pref factors) *)
...
Export["kLevListDistSevenFin.txt", kLevListDistSevenWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenWithAggShockFin.txt", kLevListDistSevenWithAggShock, "Table"];

Export[ParentDirectory[] <> "/Results/AggStatsDistSevenWithAggShockFin.txt", AggStatsWithAggShock, "Table"];
Export["MPCsListFin.txt", MPCt, "Table"];
Export[ParentDirectory[] <> "/Results/MPCListDistSevenWithAggShockFin.txt", MPCListWithAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenWithAggShockFin.tex", Round[100 MeanMPCAnnual]/100//N, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenBottomHalfFin.tex", Round[100 MeanMPCBottomHalfBykAnnual]/100//N, "Table"];

(*
Export[ParentDirectory[] <> "/Results/kAR1Coeff1GoodDistSevenFin.tex", Round[1000 kAR1ByAggState[[1,1]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff2GoodDistSevenFin.tex", Round[1000 kAR1ByAggState[[1,2]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff1BadDistSevenFin.tex",  Round[1000 kAR1ByAggState[[3,1]]]/1000//N, "Table"];
Export[ParentDirectory[] <> "/Results/kAR1Coeff2BadDistSevenFin.tex",  Round[1000 kAR1ByAggState[[3,2]]]/1000//N, "Table"];
*)
