...
*)
Export[ParentDirectory[] <> "/WithAggShocks/BetaHighTran.txt", \[Beta]Solution, "Table"];
Export[ParentDirectory[] <> "/WithAggPermShocks/BetaHighTran.txt", \[Beta]Solution, "Table"];
Export[ParentDirectory[] <> "/Results/BetaHighTran.tex", Round[10000 \[Beta]Solution]/10000//N, "Table"];
...
Export["kLevListPointNoAggShockHighTran.txt", kLevListPointNoAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListPointNoAggShockHighTran.txt", kLevListPointNoAggShock, "Table"];

Export[ParentDirectory[] <> "/Results/GiniCoeffWMeanPointNoAggShockHighTran.tex",       Round[100 GiniCoeffWMean]/100//N, "Table"];       (* gini coeff of wealth *)
Export[ParentDirectory[] <> "/Results/GiniCoeffWEndMeanPointNoAggShockHighTran.tex",    Round[100 GiniCoeffWEndMean]/100//N, "Table"];    (* gini coeff of wealth at end-period *)
Export[ParentDirectory[] <> "/Results/GiniCoeffPermIncMeanPointNoAggShockHighTran.tex", Round[100 GiniCoeffPermIncMean]/100//N, "Table"]; (* gini coeff of perm inc *)
Export[ParentDirectory[] <> "/Results/StdLogMeanPointNoAggShockHighTran.tex",           Round[100 StdLogMean]/100//N, "Table"];           (* std of wealth *)
Export[ParentDirectory[] <> "/Results/StdLogEndMeanPointNoAggShockHighTran.tex",        Round[100 StdLogEndMean]/100//N, "Table"];        (* std of wealth at end-period *)
Export[ParentDirectory[] <> "/Results/StdLogPermIncMeanPointNoAggShockHighTran.tex",    Round[100 StdLogPermIncMean]/100//N, "Table"];    (* std of perm inc *)

Export[ParentDirectory[] <> "/Results/MPCPointNoAggShockHighTran.txt", AggMPCMeanAnnual, "Table"];
Export[ParentDirectory[] <> "/Results/KYPointNoAggShockHighTran.txt", (KLevMean/lbar/L)^(1-CapShare), "Table"];
