(* FindBetaDistSevenLiqFinPlsRetDeathFrAge.m *)
...
(* Death from age at 100 yrs is incorporated *)
...
DeathFromAge             = Yes;  (* Death from age at 100 yrs is incorporated *)


(* Set parameter values and set up routines *)
Initial\[Beta]middle           = 0.9600;           (* Initial guess of \[Beta]middle *) 
...
Export["kLevListDistSevenNoAggShockLiqFinPlsRetDeathFrAge.txt", kLevListDistSevenNoAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenNoAggShockLiqFinPlsRetDeathFrAge.txt", kLevListDistSevenNoAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenNoAggShockLiqFinPlsRetDeathFrAge.txt", AggMPCMeanAnnual, "Table"];
Export[ParentDirectory[] <> "/Results/KYDistSevenNoAggShockLiqFinPlsRetDeathFrAge.txt", (KLevMean/lbar/L)^(1 - CapShare), "Table"];

Export["diffLiqFinPlsRetDeathFrAge.txt", diff, "Table"];
Export["BetamiddleLiqFinPlsRetDeathFrAge.txt", \[Beta]middleSolution, "Table"];
Export[ParentDirectory[] <> "/WithAggShocks/diffLiqFinPlsRetDeathFrAge.txt", diff, "Table"];
Export[ParentDirectory[] <> "/WithAggShocks/BetamiddleLiqFinPlsRetDeathFrAge.txt", \[Beta]middleSolution, "Table"];
Export[ParentDirectory[] <> "/WithAggPermShocks/diffLiqFinPlsRetDeathFrAge.txt", diff, "Table"];
Export[ParentDirectory[] <> "/WithAggPermShocks/BetamiddleLiqFinPlsRetDeathFrAge.txt", \[Beta]middleSolution, "Table"];

Export[ParentDirectory[] <> "/Results/BetamiddleLiqFinPlsRetDeathFrAge.tex", Round[10000 \[Beta]middleSolution]/10000//N, "Table"];
Export[ParentDirectory[] <> "/Results/NablaLiqFinPlsRetDeathFrAge.tex",      Round[10000 3.5 diff]/10000//N, "Table"];
Export[ParentDirectory[] <> "/Results/BetaLowLiqFinPlsRetDeathFrAge.tex", Round[10000 (\[Beta]middleSolution - 3.5 diff)]/10000 // N, "Table"];
Export[ParentDirectory[] <> "/Results/BetaHighLiqFinPlsRetDeathFrAge.tex",Round[10000 (\[Beta]middleSolution + 3.5 diff)]/10000 // N, "Table"];
