...
Initialdiff                    = 0.0015;           (* Initial value of diff (difference between approximated points of time pref factor) *)
diff                           = Initialdiff; 
...
Export["kLevListDistSevenNoAggShock.txt", kLevListDistSevenNoAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenNoAggShock.txt", kLevListDistSevenNoAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenNoAggShock.txt", AggMPCMeanAnnual, "Table"];
Export[ParentDirectory[] <> "/Results/KYDistSevenNoAggShock.txt", (KLevMean/lbar/L)^(1 - CapShare), "Table"];

Export["diff.txt", diff, "Table"];
Export["Betamiddle.txt", \[Beta]middleSolution, "Table"];
Export[ParentDirectory[] <> "/WithAggShocks/diff.txt", diff, "Table"];
Export[ParentDirectory[] <> "/WithAggShocks/Betamiddle.txt", \[Beta]middleSolution, "Table"];
Export[ParentDirectory[] <> "/WithAggPermShocks/diff.txt", diff, "Table"];
Export[ParentDirectory[] <> "/WithAggPermShocks/Betamiddle.txt", \[Beta]middleSolution, "Table"];

Export[ParentDirectory[] <> "/Results/Betamiddle.tex", Round[10000 \[Beta]middleSolution]/10000//N, "Table"];
Export[ParentDirectory[] <> "/Results/Nabla.tex",      Round[10000 3.5 diff]/10000//N, "Table"];
Export[ParentDirectory[] <> "/Results/BetaLow.tex", Round[10000 (\[Beta]middleSolution - 3.5 diff)]/10000 // N, "Table"];
Export[ParentDirectory[] <> "/Results/BetaHigh.tex",Round[10000 (\[Beta]middleSolution + 3.5 diff)]/10000 // N, "Table"];

Export[ParentDirectory[] <> "/Results/GiniCoeffWMeanDistSevenNoAggShock.tex",       Round[100 GiniCoeffWMean]/100//N, "Table"];       (* gini coeff of wealth *)
Export[ParentDirectory[] <> "/Results/GiniCoeffWEndMeanDistSevenNoAggShock.tex",    Round[100 GiniCoeffWEndMean]/100//N, "Table"];    (* gini coeff of wealth at end-period *)
Export[ParentDirectory[] <> "/Results/GiniCoeffPermIncMeanDistSevenNoAggShock.tex", Round[100 GiniCoeffPermIncMean]/100//N, "Table"]; (* gini coeff of perm inc *)
Export[ParentDirectory[] <> "/Results/StdLogMeanDistSevenNoAggShock.tex",           Round[100 StdLogMean]/100//N, "Table"];           (* std of wealth *)
Export[ParentDirectory[] <> "/Results/StdLogEndMeanDistSevenNoAggShock.tex",        Round[100 StdLogEndMean]/100//N, "Table"];        (* std of wealth at end-period *)
Export[ParentDirectory[] <> "/Results/StdLogPermIncMeanDistSevenNoAggShock.tex",    Round[100 StdLogPermIncMean]/100//N, "Table"];    (* std of perm inc *)
