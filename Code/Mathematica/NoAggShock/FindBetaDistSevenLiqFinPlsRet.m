...
Initial\[Beta]middle           = 0.9650;           (* Initial guess of \[Beta]middle *) 
...
Export["kLevListDistSevenNoAggShockLiqFinPlsRet.txt", kLevListDistSevenNoAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/kLevListDistSevenNoAggShockLiqFinPlsRet.txt", kLevListDistSevenNoAggShock, "Table"];
Export[ParentDirectory[] <> "/Results/MPCDistSevenNoAggShockLiqFinPlsRet.txt", AggMPCMeanAnnual, "Table"];
Export[ParentDirectory[] <> "/Results/KYDistSevenNoAggShockLiqFinPlsRet.txt", (KLevMean/lbar/L)^(1 - CapShare), "Table"];

Export["diffLiqFinPlsRet.txt", diff, "Table"];
Export["BetamiddleLiqFinPlsRet.txt", \[Beta]middleSolution, "Table"];
Export[ParentDirectory[] <> "/WithAggShocks/diffLiqFinPlsRet.txt", diff, "Table"];
Export[ParentDirectory[] <> "/WithAggShocks/BetamiddleLiqFinPlsRet.txt", \[Beta]middleSolution, "Table"];
Export[ParentDirectory[] <> "/WithAggPermShocks/diffLiqFinPlsRet.txt", diff, "Table"];
Export[ParentDirectory[] <> "/WithAggPermShocks/BetamiddleLiqFinPlsRet.txt", \[Beta]middleSolution, "Table"];

Export[ParentDirectory[] <> "/Results/BetamiddleLiqFinPlsRet.tex", Round[10000 \[Beta]middleSolution]/10000//N, "Table"];
Export[ParentDirectory[] <> "/Results/NablaLiqFinPlsRet.tex",      Round[10000 3.5 diff]/10000//N, "Table"];
Export[ParentDirectory[] <> "/Results/BetaLowLiqFinPlsRet.tex", Round[10000 (\[Beta]middleSolution - 3.5 diff)]/10000 // N, "Table"];
Export[ParentDirectory[] <> "/Results/BetaHighLiqFinPlsRet.tex",Round[10000 (\[Beta]middleSolution + 3.5 diff)]/10000 // N, "Table"];
